...
namespace Syncer.Elasticsearch.Abstractions
{
    ...
    public interface IElasticsearchRepositoryAsync
    {
        ...
        /// <returns></returns>
        Task<IndexResponse> SaveAsync<T>(T document, string index = null, bool? refreshOnSave = null) where T : class;
        /// <summary>
        ...
        Task<BulkResponse> BulkAsync<T>(IEnumerable<T> documents, string index = null, bool? refreshOnSave = null) where T : class;
        /// <summary>
        ...
        /// <returns></returns>
        Task<DeleteResponse> DeleteAsync<T>(T document, string index = null, bool? refreshOnDelete = null) where T : class;
        /// <summary>
        ...
        /// <param name="refreshOnDelete">specifies whether to refresh the search index after completing the delete operation, only use when you understand the impact</param>
        /// <returns></returns>
        Task<DeleteResponse> DeleteAsync<T>(string id, string index = null, bool? refreshOnDelete = null) where T : class;
        /// <summary>
